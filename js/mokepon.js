...
const divPeleaDigimon = document.getElementById('pelea-digimon')
const divAnimacionAtaques = document.getElementById('animacion-ataques')
...
function iniciarJuego() {
    ...
    mokepones.forEach((mokepon) => {
        ...
        <label class="tarjeta-de-mokepon" for=${mokepon.nombre}>
            <p>${mokepon.nombre}</p>
            <img src=${mokepon.foto} alt=${mokepon.nombre} id=${mokepon.nombre+'-foto'}>
        </label>
        `
    ...
    inputHipodoge.addEventListener('click', cambiarImagenAgumon)
    inputCapipepo.addEventListener('click', cambiarImagenVeemon)
    inputRatigueya.addEventListener('click', cambiarImagenGuilmon)
}

function cambiarImagenGuilmon(){
    fotoAgumon.src = hipodoge.foto
    fotoVeemon.src = capipepo.foto
    fotoGuilmon.src = './assets/guilmon_click.png'
}

function cambiarImagenVeemon(){
    fotoAgumon.src = hipodoge.foto
    fotoVeemon.src = './assets/veemon_click.png'
    fotoGuilmon.src= ratigueya.foto
}


function cambiarImagenAgumon(){
    fotoAgumon.src = './assets/agumon_click.png'
    fotoVeemon.src = capipepo.foto
    fotoGuilmon.src= ratigueya.foto
}
    ...
    botones.forEach((boton) => {
        boton.addEventListener('click', (e) => {
            if (e.target.textContent === '🔥') {
                ...
                boton.disabled = true
                divAnimacionAtaques.innerHTML = `<span id="animacion-ataque">🔥<span>` 
...
function seleccionarMascotaEnemigo(enemigo) {
    ...
    divPeleaDigimon.innerHTML = `<img src=${mascotaJugadorObjeto.foto} id=${mascotaJugadorObjeto.nombre+'-pelea'} class='foto-pelea'><img src=${enemigo.foto} id=${enemigo.nombre+'-pelea'} class='foto-pelea'>`
    secuenciaAtaque()
}
